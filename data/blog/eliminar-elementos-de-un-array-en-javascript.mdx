...
tags: ['javascript']
draft: false
summary: Hay varias formas e eliminar elementos en JavaScript dependiendo la situación podrás utilizar una u otra. Podemos eliminar el primer elemento, el último, basado en su intice, filtrando el erray, entre otras formas.
